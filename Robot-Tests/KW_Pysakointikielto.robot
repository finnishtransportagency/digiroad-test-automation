...
Pysakointi_1    [Arguments]    ${Tietolaji}    ${Testipaikka}
    ...
    Click Center Of The Map And Wait For Locator   ${FA_Pysakointikielto_A}
    ...
    Odota Sivun Latautuminen
    Log
    ...    Yhden linkin mittaisen Pysäköintirajoituksen katkaisun ja tallennuksen jälkeen valintatyökalu jää aktiiviseksi, 206.101
    ...
    Nollaa Pysakointikielto
    Log
    ...    Valittaessa Pysäköintirajoituksen ominaisuustietonäkymässä näkyy Pysäköintirajoituksen ID, lisäys ja muokkaus tiedot. 206.30
    Click Center Of The Map And Wait For Locator    ${FA_otsikko}
    Element Should Contain     ${FA_Pysakointikielto}    ei ole
...
Pysakointi_2    [Arguments]    ${Tietolaji}    ${Testipaikka}
    ...
    Wait Until Element contains    ${FA_Pysakointikielto}    ei ole    timeout=5
...
Nollaa Pysakointikielto
    ...
    Siirry Katselutilaan
    Click Center Of The Map And Wait For Locator    ${FA_otsikko}
    Element Should Contain    ${FA_Pysakointikielto}
    ...    ei ole
    ...    message=Pysäköintikiellon arvon olisi pitänyt olla (ei ole)
