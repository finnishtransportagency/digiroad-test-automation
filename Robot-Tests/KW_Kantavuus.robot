...
Kevätkantavuus_lisäys
    [arguments]    ${testipaikka}    ${routivuuskerroin}
    #testitapaus nro 3
    Testin Aloitus
    ...
    Sleep    2
    Click Center Of The Map And Wait For Locator    ${Kantavuus_header_otsikko}
...
Kantavuus_lisäys_virheellinen
    [arguments]    ${testipaikka}    ${virheellinen}
    #testitapaus 3 f I
    Testin Aloitus
    Log    Tarkistetaan kevätkantavuuden lisäys
    Vaihda Tietolaji    ${TL_Kantavuus_RB}
...
Kantavuuden katkaisu
    ...
    Odota sivun latautuminen
    Click Center Of The Map And Wait For Locator    ${Kantavuus_leikkausnäkymä_A}
...
Kantavuuden lisäys katkaisua varten    [arguments]    ${routivuuskerroin}
    Odota sivun latautuminen
    Click Center Of The Map And Wait For Locator    ${Kantavuus_header_linkkien_lukumäärä}
    ...
    #Element Should Be Visible    ${Kantavuus_header_linkkien_lukumäärä}  
    Element Should Be Disabled    ${FA_header_Tallenna}
    ${kantavuus_katkaisu_evaluointi} =    Run Keyword And Return Status
    ...    Radio Button Should Be Set To    ${Kantavuus_radionappi_header_kantavuus}    disabled
