...
@{Huoltotie_käyttöoikeus_kohteet}
...                                   Tieoikeus    Tiekunnan osakkuus
...                                   LiVin hallinnoimalla maa-alueella
...                                   Kävelyn ja pyöräilyn väylä    Muu sopimus
...                                   Potentiaalinen käyttöoikeus    Tuntematon
...
Rautateiden Huoltotien Muokkaus Koko Ketjulle
    ...
    FOR    ${j}    IN    @{Huoltotie_käyttöoikeus_kohteet}
        Log    ${j}
        KW_Rautatien_huoltotie.Rautateiden Huoltotien Muokkaus Koko Ketjulle
        ...    6747441, 481740    ${j}
    END
...
Rautateiden Huoltotien Muokkaus Ketjun Osalle
    ...
    FOR    ${k}    IN    @{Huoltotie_käyttöoikeus_kohteet}
        Log    ${k}
        KW_Rautatien_huoltotie.Rautateiden Huoltotien Muokkaus Ketjun Osalle
        ...    6747441, 481740    ${k}
    END
