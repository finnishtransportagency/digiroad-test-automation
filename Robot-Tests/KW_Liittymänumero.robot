...
*** Settings ***
Documentation       Keywords for intersection number (Liittymänumero)
...
Liittymänumeron tarkastelu    [arguments]    ${testipaikka}
    ...
    Element Should Contain                      ${Liittymänumero_header_arvo}    75
...
Liittymänumeron katkaisu    [arguments]    ${testipaikka}    ${eurooppatienumero_luku}
    Testin Aloitus
    ...
    Element Attribute Value Should Be           ${Liittymänumero_katkaistu_a}    value    ${eurooppatienumero_luku}
    Element Attribute Value Should Be           ${Liittymänumero_katkaistu_b}    value    ${eurooppatienumero_luku}
    Element Attribute Value Should Be           ${Liittymänumero_katkaistu_b}    value    ${eurooppatienumero_luku}
    Element Attribute Value Should Be           ${Liittymänumero_katkaistu_b}    value    ${eurooppatienumero_luku}
...
${Liittymänumero_näkymä_radionappi_group}             name=european-road
